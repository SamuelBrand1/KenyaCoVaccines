...
load(file = "model_outputs/health_system_persp/CEA_MODEL_OUTPUT_10_scenario_2baseline_scenario_1.rda")
case.21=as.data.frame(CEA_output)
load(file = "model_outputs/health_system_persp/CEA_MODEL_OUTPUT_10_scenario_3baseline_scenario_1.rda")
case.31=as.data.frame(CEA_output)
load(file = "model_outputs/health_system_persp/CEA_MODEL_OUTPUT_10_scenario_4baseline_scenario_1.rda")
case.41=as.data.frame(CEA_output)
load(file = "model_outputs/health_system_persp/CEA_MODEL_OUTPUT_10_scenario_5baseline_scenario_1.rda")
case.51=as.data.frame(CEA_output)
load(file = "model_outputs/health_system_persp/CEA_MODEL_OUTPUT_10_scenario_6baseline_scenario_1.rda")
case.61=as.data.frame(CEA_output)
load(file = "model_outputs/health_system_persp/CEA_MODEL_OUTPUT_10_scenario_7baseline_scenario_1.rda")
...
ICER_M1 = MeanCI(data.matrix((c1[,1]-c1[,2])/(e1[,1]-e1[,2])))
ICER_M2 = MeanCI(data.matrix((c2[,1]-c2[,2])/(e2[,1]-e2[,2])))
ICER_M3 = MeanCI(data.matrix((c3[,1]-c3[,2])/(e3[,1]-e3[,2])))
ICER_M4 = MeanCI(data.matrix((c4[,1]-c4[,2])/(e4[,1]-e4[,2])))
ICER_M5 = MeanCI(data.matrix((c5[,1]-c5[,2])/(e5[,1]-e5[,2])))
ICER_M6 = MeanCI(data.matrix((c6[,1]-c6[,2])/(e6[,1]-e6[,2])))
...
# # #plot societal perspective graphs
# par(mfrow=c(2,3))
# 
# ceplane.plot(m1,wtp=919.105,
#              pos="false",
